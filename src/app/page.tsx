...
export default function HomePage() {
  return <main className="container-shell space-y-12 py-5 sm:py-8 lg:space-y-16 lg:py-10">
    ...
    <section className="grid gap-4 md:grid-cols-2"><Card><SectionHeader title="Maintenance Timeline Preview" /><p className="text-sm leading-6 text-text-secondary">엔진오일 교체 · 체인 점검 · 브레이크 패드 교체를 타임라인으로 정리합니다.</p></Card><Card><SectionHeader title="Category Boards" action={<Link href="/explore/" className="text-xs font-semibold text-garage-orange">전체 카테고리</Link>} /><p className="text-sm leading-6 text-text-secondary">카테고리별 장비 자랑, 정비/관리 기록, 부품 리뷰, 질문 게시판으로 이동할 수 있습니다.</p></Card></section>
