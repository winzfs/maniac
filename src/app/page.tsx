...
export default function HomePage() {
  return <main className="container-shell space-y-10 py-6">
    <header className="flex items-center justify-between"><h1 className="text-xl font-bold">Maniac Garage</h1><Button>시작하기</Button></header>
    ...
    <section><Card className="bg-graphite text-white"><h3 className="text-xl font-bold">지금 내 차고를 공개해보세요.</h3><p className="mt-2 text-sm text-zinc-300">정비 히스토리와 튜닝 기록을 신뢰도 높은 링크로 공유하세요.</p><Button className="mt-4">무료로 시작</Button></Card></section>
