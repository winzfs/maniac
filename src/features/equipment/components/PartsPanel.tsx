              ...
              <article key={part.id} className="rounded-2xl border border-border bg-surface p-4">
                {isEditing ? (
                  ...
                  <div className="flex gap-3">
                    {part.image_url ? <img src={part.image_url} alt="부품 사진" className="aspect-square h-20 w-20 shrink-0 rounded-2xl border border-border object-cover" /> : <div className="flex aspect-square h-20 w-20 shrink-0 items-center justify-center rounded-2xl border border-dashed border-border bg-background text-[0.65rem] font-bold text-text-secondary">NO IMG</div>}
