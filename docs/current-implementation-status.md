...
### 4.5 글쓰기 `/explore/[category]/[board]/write/`
...
### 4.8 공개 장비 페이지 `/garage/ninja-400/`
...
따라서 다음 작업은 **migration 검증 후 장비 CRUD UI** 또는 **게시글 저장/sanitize/R2 업로드 연결** 중 하나다.
