...
function renderEquipment(row: EquipmentRow) {
...
<body>
  <main>
    ...
    <section class="section">
      <h2>정비 타임라인</h2>
      <p>정비 기록, 부품, 사진 갤러리는 다음 단계에서 DB와 연결됩니다.</p>
    </section>
  </main>
</body>
</html>`);
